...
public class AddCustomerWorkerController implements Initializable {
    ...
    void save(MouseEvent event) {
        ...
        if (contractDayPicker.getValue() == null || autopaymentBox.getValue() == null) {
            ...
            String name = nameTextField.getText(),companyName = companyNameField.getText(),phone = phoneTextField.getText(),address = addressTextField.getText(), DOB = DOBField.getText(), cardNumber = cardNumberField.getText(),
                    cardValidity = cardValidityField.getText(), contractDay = contractDayPicker.getValue().toString(), contractPeriod = autopaymentBox.getSelectionModel().getSelectedItem(), performance = performanceField.getText(),
